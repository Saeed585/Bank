Public Class LCD
    Private Sub FillCode()
        Dim objDataAdapter As New SqlDataAdapter _
            (" SELECT MAX(Lcd_code) AS Expr1 FROM Bas.LCD", objConnection)
        objDataset = New DataSet
        objDataAdapter.Fill(objDataset, "Bas.LCD")
        objDataview = New DataView(objDataset.Tables("Bas.LCD"))
    ...
    Private Sub LCD_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        FillCode()
        FillDataSetAndDataView()
        FillDataGridView()
    End Sub

    Private Sub LCD_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub LCD_Resize(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Resize
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Else
            ...
            objCommand.CommandText = _
               " INSERT INTO Bas.LCD (Lcd_code, Lcd_name) VALUES (@code ,@name)"
    ...
    Private Sub btnEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEdit.Click
        ...
        Else
            ...
            objCommand.Connection = objConnection
            objCommand.CommandText = _
               " Update Bas.LCD SET Lcd_name='" & txtName.Text & "' WHERE(Lcd_code=" & maskCode.Text & ")"
            objCommand.CommandType = CommandType.Text
            objCommand.Parameters.Clear()
    ...
    Private Sub btnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        ...
        Else
            ...
            Else
                ...
                objCommand.Connection = objConnection
                objCommand.CommandText = _
                   " DELETE FROM Bas.LCD WHERE(Lcd_code = " & maskCode.Text & ")"
    ...
    Private Sub txtSrch_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtSrch.TextChanged
        FillDataSetAndDataView()
        objDataview.RowFilter = "Lcd_name like '" & "**" & Me.txtSrch.Text & "**" & "'"
        FillDataGridView()
    End Sub
End Class