Public Class Print
    Private Sub FillCode()
        Dim objDataAdapter As New SqlDataAdapter _
            (" SELECT MAX(prn_code) AS Expr1 FROM Bas.Printer", objConnection)
    ...
    Private Sub Print_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
    ...
    Private Sub Print_Resize(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Resize
        Me.ToolStripLabel2.Width = Me.tsHeader.Width - 295
    End Sub
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Else
            ...
            objCommand.CommandText = _
               " INSERT INTO Bas.Printer (prn_code, prn_name) VALUES (@code ,@name)"
    ...
    Private Sub btnEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEdit.Click
        ...
        Else
            ...
            objCommand.Connection = objConnection
            objCommand.CommandText = _
               " Update Bas.Printer SET prn_name='" & txtName.Text & "' WHERE(prn_code=" & maskCode.Text & ")"
            objCommand.CommandType = CommandType.Text
            objCommand.Parameters.Clear()
            objConnection.Open()
            Try
    ...
    Private Sub btnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        ...
        Else
            ...
            Else
                ...
                objCommand.Connection = objConnection
                objCommand.CommandText = _
                   " DELETE FROM Bas.Printer WHERE(prn_code = " & maskCode.Text & ")"
    ...
    Private Sub btnSabtSerial_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSabtSerial.Click
        PrintSerial.ShowDialog()
        PrintSerial.Activate()
    End Sub
End Class