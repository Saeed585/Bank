Public Class Vga
    Private Sub FillCode()
        Dim objDataAdapter As New SqlDataAdapter _
            (" SELECT MAX(Vga_code) AS Expr1 FROM Bas.Vga", objConnection)
        objDataset = New DataSet
        objDataAdapter.Fill(objDataset, "Bas.Vga")
        objDataview = New DataView(objDataset.Tables("Bas.Vga"))
    ...
    Private Sub FillDataSetAndDataView()
        Dim objDataAdapter As New SqlDataAdapter _
        (" SELECT Vga_code, Vga_name FROM Bas.Vga ORDER BY Vga_code", objConnection)
        objDataset = New DataSet
        objDataAdapter.Fill(objDataset, "Bas.Vga")
        objDataview = New DataView(objDataset.Tables("Bas.Vga"))
        objCurrencyManager = CType(Me.BindingContext(objDataview), CurrencyManager)
        objDataview.Sort = "Vga_code"
    End Sub
    ...
    Private Sub Vga_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        FillDataSetAndDataView()
        FillDataGridView()
        FillCode()
    End Sub

    Private Sub Vga_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub Vga_Resize(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Resize
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Else
            ...
            objCommand.CommandText = _
               " INSERT INTO Bas.Vga (Vga_code, Vga_name) VALUES (@code ,@name)"
    ...
    Private Sub btnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        ...
        Else
            ...
            Else
                ...
                objCommand.Connection = objConnection
                objCommand.CommandText = _
                   " DELETE FROM Bas.Vga WHERE(Vga_code = " & maskCode.Text & ")"
    ...
    Private Sub btnEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEdit.Click
        ...
        Else
            ...
            objCommand.Connection = objConnection
            objCommand.CommandText = _
               " Update Bas.Vga SET Vga_name='" & txtName.Text & "' WHERE(Vga_code=" & maskCode.Text & ")"
            objCommand.CommandType = CommandType.Text
            objCommand.Parameters.Clear()
            objConnection.Open()
            Try
    ...
    Private Sub txtSrch_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtSrch.TextChanged
        FillDataSetAndDataView()
        objDataview.RowFilter = "Vga_name like '" & "**" & Me.txtSrch.Text & "**" & "'"
        FillDataGridView()
    End Sub
End Class