Public Class Hdd
    Private Sub FillCode()
        Dim objDataAdapter As New SqlDataAdapter _
            (" SELECT MAX(Hdd_code) AS Expr1 FROM Bas.Hdd", objConnection)
        objDataset = New DataSet
        objDataAdapter.Fill(objDataset, "Bas.Hdd")
        objDataview = New DataView(objDataset.Tables("Bas.Hdd"))
    ...
    Private Sub FillDataSetAndDataView()
        Dim objDataAdapter As New SqlDataAdapter _
        (" SELECT Hdd_code, Hdd_name FROM Bas.Hdd ORDER BY Hdd_code", objConnection)
        objDataset = New DataSet
        objDataAdapter.Fill(objDataset, "Bas.Hdd")
        objDataview = New DataView(objDataset.Tables("Bas.Hdd"))
        objCurrencyManager = CType(Me.BindingContext(objDataview), CurrencyManager)
        objDataview.Sort = "Hdd_code"
    End Sub
    ...
    Private Sub Hdd_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        FillDataSetAndDataView()
        FillDataGridView()
        FillCode()
    End Sub

    Private Sub Hdd_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub Hdd_Resize(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Resize
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Else
            ...
            objCommand.CommandText = _
               " INSERT INTO Bas.Hdd (Hdd_code, Hdd_name) VALUES (@code ,@name)"
    ...
    Private Sub btnEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEdit.Click
        ...
        Else
            ...
            objCommand.Connection = objConnection
            objCommand.CommandText = _
               " Update Bas.Hdd SET Hdd_name='" & txtName.Text & "' WHERE(Hdd_code=" & maskCode.Text & ")"
            objCommand.CommandType = CommandType.Text
            objCommand.Parameters.Clear()
    ...
    Private Sub btnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        ...
        Else
            ...
            Else
                ...
                objCommand.Connection = objConnection
                objCommand.CommandText = _
                   " DELETE FROM Bas.Hdd WHERE(Hdd_code = " & maskCode.Text & ")"
    ...
    Private Sub txtSrch_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtSrch.TextChanged
        FillDataSetAndDataView()
        objDataview.RowFilter = "Hdd_name like '" & "**" & Me.txtSrch.Text & "**" & "'"
        FillDataGridView()
    End Sub
End Class