Public Class Cpu
    Private Sub FillCode()
        Dim objDataAdapter As New SqlDataAdapter _
            (" SELECT MAX(Cpu_Code) AS Expr1 FROM Bas.Cpu", objConnection)
        objDataset = New DataSet
        objDataAdapter.Fill(objDataset, "Bas.Cpu")
        objDataview = New DataView(objDataset.Tables("Bas.Cpu"))
    ...
    Private Sub FillDataSetAndDataView()
        Dim objDataAdapter As New SqlDataAdapter _
        (" SELECT Cpu_code, Cpu_name FROM Bas.Cpu ORDER BY Cpu_code", objConnection)
        objDataset = New DataSet
        objDataAdapter.Fill(objDataset, "Bas.Cpu")
        objDataview = New DataView(objDataset.Tables("Bas.Cpu"))
        objCurrencyManager = CType(Me.BindingContext(objDataview), CurrencyManager)
        objDataview.Sort = "Cpu_code"
    End Sub
    ...
    Private Sub Cpu_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
    ...
    Private Sub Cpu_Resize(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Resize
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Else
            ...
            objCommand.CommandText = _
               " INSERT INTO Bas.Cpu (Cpu_code, Cpu_name) VALUES (@code ,@name)"
    ...
    Private Sub btnEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEdit.Click
        ...
        Else
            ...
            objCommand.Connection = objConnection
            objCommand.CommandText = _
               " Update Bas.Cpu SET Cpu_name='" & txtName.Text & "' WHERE(Cpu_code=" & maskCode.Text & ")"
            objCommand.CommandType = CommandType.Text
            objCommand.Parameters.Clear()
    ...
    Private Sub btnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        ...
        Else
            ...
            Else
                ...
                objCommand.Connection = objConnection
                objCommand.CommandText = _
                   " DELETE FROM Bas.Cpu WHERE(Cpu_code = " & maskCode.Text & ")"
    ...
    Private Sub txtSrch_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtSrch.TextChanged
        FillDataSetAndDataView()
        objDataview.RowFilter = "Cpu_name like '" & "**" & Me.txtSrch.Text & "**" & "'"
        FillDataGridView()
    End Sub
End Class